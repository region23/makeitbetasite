...
**Сокращённый пример формы.** Полная форма со всеми обязательными полями — [в Markdown](../../ai_native_book/templates/ai-loop-passport.md).
...
**Сокращённый пример формы.** Полная форма со всеми обязательными полями — [в Markdown](../../ai_native_book/templates/use-case-canvas.md).
...
**Сокращённый пример формы.** Полная форма с ценой ошибки, условием остановки и резервом — [в Markdown](../../ai_native_book/templates/decision-rights-map.md).
...
**Сокращённый пример формы.** Полная форма с резервным сценарием на случай недоступности источника — [в Markdown](../../ai_native_book/templates/context-register.md).
...
**Сокращённый пример формы.** Полная форма со всеми обязательными полями — [в Markdown](../../ai_native_book/templates/agent-skill.md).
...
**Сокращённый пример формы.** Полная форма со всеми обязательными полями — [в Markdown](../../ai_native_book/templates/eval-plan.md).
...
**Сокращённый пример формы.** Полная форма с ценой ошибки, реакцией и резервом — [в Markdown](../../ai_native_book/templates/risk-register.md).
...
**Сокращённый пример формы.** Полная форма с областью данных, техническими правами, лимитами и резервным режимом — [в Markdown](../../ai_native_book/templates/autonomy-contract.md).
...
**Сокращённый пример формы.** Полная форма со всеми обязательными полями — [в Markdown](../../ai_native_book/templates/ai-pr.md).
...
**Сокращённый пример формы.** Полная форма со всеми обязательными полями — [в Markdown](../../ai_native_book/templates/incident-to-check.md).
...
**Сокращённый пример формы.** Полная форма со всеми обязательными полями — [в Markdown](../../ai_native_book/templates/cost-to-outcome.md).
...
**Кто отвечает:** основатель отвечает за инвестицию и остановку; владелец процесса ведёт действия и принятый результат.

**Сокращённый пример формы.** Полная форма с этапами, резервом и решениями дня 30 и дня 90 — [в Markdown](../../ai_native_book/templates/startup-90-days.md).
...
**Сокращённый пример формы.** Полная форма с этапами, повторной приёмкой, резервом и тремя решениями — [в Markdown](../../ai_native_book/templates/mature-company-180-days.md).
...
**Короткий пример:** к дню 30 компания выбирает поток и ограничивает права; к дню 90 проводит ограниченный выпуск; к дню 180 принимает общий компонент во втором потоке и принимает портфельное решение.
