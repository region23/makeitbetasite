// English source text for the optional sentence-level comparison layer.
window.AI_NATIVE_SDLC_ORIGINALS = Object.freeze({
  ...
  blocks: Object.freeze([
    ...
    "Claude synthesizes pain points straight from the sources and captures them within intent.md which is human readable and machine actionable",
    "Design",
    ...
    "Tests and code are generated by AI and institutional knowledge is maintained as versioned machine-readable CLAUDE.md files and skills",
    "Test",
    ...
    "Agents monitor live deployments. Any breached control band is diagnosed and written back into the loop as a new intent.md",
    ...
    "Set up Claude Code for your organization — the admin decision map; start herecode.claude.com/docs/en/admin-setup",
    "Settings reference and precedence, including every managed-only keycode.claude.com/docs/en/settings",
    "Server-managed settings from the Claude admin consolecode.claude.com/docs/en/server-managed-settings",
    "Permissionscode.claude.com/docs/en/permissions",
    "Sandboxing — OS-level filesystem and network isolationcode.claude.com/docs/en/sandboxing",
    "Hooks — guidecode.claude.com/docs/en/hooks-guide",
    "Hooks — referencecode.claude.com/docs/en/hooks",
    "Skillscode.claude.com/docs/en/skills",
    "Plugins and private marketplaces — how skills and hooks are distributed organization-widecode.claude.com/docs/en/plugin-marketplaces",
    "Managed MCP — central control of the agent's tool surfacecode.claude.com/docs/en/managed-mcp",
    "Enterprise deployment overview — Bedrock, Vertex, Foundrycode.claude.com/docs/en/third-party-integrations",
    "Enterprise network configurationcode.claude.com/docs/en/network-config",
    "Monitoring (OpenTelemetry)code.claude.com/docs/en/monitoring-usage",
    "The analytics dashboardcode.claude.com/docs/en/analytics",
    "Compliance API — Enterprise activity feed, chat retrieval and deletionplatform.claude.com/docs/en/manage-claude/compliance-api",
    "Security modelcode.claude.com/docs/en/security",
